...
module.exports.sendEmail = async (address, subject, dataSend) => {
  const html = `<div class="container" style="box-sizing: border-box;width: 100%;padding-right: 15px;padding-left: 15px;margin-right: auto;margin-left: auto;min-width: 992px!important;">
